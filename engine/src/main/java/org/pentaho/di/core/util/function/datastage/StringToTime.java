...
public class StringToTime extends Operator{

    private static final long serialVersionUID = 1L;

    /**
     * StringToTime('090102',"%hh%nn%ss")
     * @param string
     * @param format
     * @return date
     * @throws Exception
     */
    public Date stringToTime(String string, String format) throws Exception {
        Date date = new Date();
        int year=0;
...
//                    break;
    ...
    public Date stringToTime(String str) throws Exception {
        return stringToTime(str,"%hh:%nn:%ss");
    }
    ...
    public Date executeInner(Object[] objects) throws Exception {
        ...
        switch (length){
            case 1 :
                return stringToTime(o.toString());
            case 2 :
                Object o1 = objects[1];
                if(o1 == null ){
                    return null;
                }
                return stringToTime(o.toString(),o1.toString());
            default: return null;
        }
    }
    ...
    public enum dateTags{
        ...
        ddd,//Day_of_year,
        hh,//Month_of_year_variable_width,
        nn,//Month_of_year_fixed_width,
        sss,//Month_of_year_short_name,
    ...
    {
        StringToTime stringToTimestamp= new StringToTime();
        try {
            Date date1 = stringToTimestamp.stringToTime("15-1","%dd-%m");
            System.out.println(date1);
            Date date2 = stringToTimestamp.stringToTime("16-01","%dd-%mm");
            System.out.println(date2);
            Date date3 = stringToTimestamp.stringToTime("17-   01","%(dd)-%(mm,s)");
            System.out.println(date3);
            Date date4 = stringToTimestamp.stringToTime("   19-   01","%(dd,s)-%(mm,s)");
            System.out.println(date4);
            Date date5 = stringToTimestamp.stringToTime("   19-   01-2015","%(dd,s)-%(mm,s)-%yyyy");
            System.out.println(date5);
            Date date6 = stringToTimestamp.stringToTime("19261212","%yyyy%mm%dd");
            System.out.println(date6);
            Date date7 = stringToTimestamp.stringToTime("1980-02-12","%yyyy-%mm-%dd");
