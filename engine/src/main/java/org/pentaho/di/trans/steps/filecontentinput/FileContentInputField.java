 ...
 *
 */
public class FileContentInputField implements Cloneable {
  ...
  public FileContentInputField(String fieldname ) {
    this.name = fieldname;
  ...
  public FileContentInputField(Node fnode ) throws KettleValueException {
  ...
  public Object clone() {
    try {
      FileContentInputField retval = (FileContentInputField) super.clone();
