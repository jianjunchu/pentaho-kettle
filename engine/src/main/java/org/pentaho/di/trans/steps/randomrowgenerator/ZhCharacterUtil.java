...
public class ZhCharacterUtil {
    public static java.util.Properties streets;
    ...
    public static String generateName() {
        ...
        namebuilder.append(lastname[random.nextInt(lastname.length)]);
        namebuilder.append(firstname[random.nextInt(firstname.length)]);
        if (random.nextInt(2) == 1) namebuilder.append(firstname[random.nextInt(firstname.length)]);
    ...
    public static String generateMobilePhone() {
        ...
        for (int j = 0; j < 10; j++) {
            //生成0~9 随机数
            mobilebuilder.append(random.nextInt(10));
        }
    ...
    public static String generateHouseNumber() {
        ...
        String[] house1 = {"-", "弄", "栋", "幢", "组"};
        String[] house2 = {"-", "单元",  "排","门"};
        String[] house3 = { "号", ""};
        StringBuilder housenumberbuilder = new StringBuilder();

        housenumberbuilder.append(random.nextInt(90)+1 );
        housenumberbuilder.append(house1[random.nextInt(house1.length)]);

        housenumberbuilder.append(random.nextInt(9)+1 );
        housenumberbuilder.append(house2[random.nextInt(house2.length)]);

        housenumberbuilder.append(random.nextInt(900) + 1);
        housenumberbuilder.append(house3[random.nextInt(house3.length)]);

        return housenumberbuilder.toString();
    }

    /*
        generate address
    */
    public static String generateAddr() throws Exception{
        if(streets==null)
            throw new Exception("steet properties is not loaded");
        Random random = new Random();//定义random，产生随机数
        String key = new Integer(random.nextInt(streets.size())).toString();
        return streets.get(key)+generateHouseNumber();
    }

    /*generate random chinese characters with specified length*/
    public static String generateRandomCharacters(int length) {
        StringBuilder charactersbuilder = new StringBuilder();//定义电话号码以1开头
        Random random = new Random();//定义random，产生随机数
        for (int j = 0; j < length; j++) {
            //生成0~9 随机数
            charactersbuilder.append(commoncharacter[random.nextInt(2500)]);
        }
...
//        System.out.println(ZhCharacterUtil.generateName());
//        System.out.println(ZhCharacterUtil.generateMobilePhone());
//        System.out.println(ZhCharacterUtil.generateHouseNumber());
        System.out.println(ZhCharacterUtil.generateRandomCharacters(100));
    }
