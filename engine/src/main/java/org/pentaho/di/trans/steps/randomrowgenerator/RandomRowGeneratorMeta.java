 ...
 */
public class RandomRowGeneratorMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public void allocate( int nrfields ) {
    ...
    minValue = new String[nrfields];
    maxValue = new String[nrfields];
    enumValue = new String[nrfields];
    prefixValue = new String[nrfields];
    suffixValue = new String[nrfields];
    characterType = new String[nrfields];
    regularExpress = new String[nrfields];
    setEmptyString = new boolean[nrfields];
  }

  public Object clone() {
    RandomRowGeneratorMeta retval = (RandomRowGeneratorMeta) super.clone();
    ...
    System.arraycopy( minValue, 0, retval.minValue, 0, nrfields );
    System.arraycopy( maxValue, 0, retval.maxValue, 0, nrfields );
    System.arraycopy( enumValue, 0, retval.enumValue, 0, nrfields );
    System.arraycopy( prefixValue, 0, retval.prefixValue, 0, nrfields );
    System.arraycopy( suffixValue, 0, retval.suffixValue, 0, nrfields );
    System.arraycopy( characterType, 0, retval.characterType, 0, nrfields );
    System.arraycopy( regularExpress, 0, retval.regularExpress, 0, nrfields );
  ...
  private void readData( Node stepnode ) throws KettleXMLException {
    try {
      ...
      for ( int i = 0; i < nrfields; i++ ) {
        ...
        minValue[i] = XMLHandler.getTagValue( fnode, "minValue" );
        maxValue[i] = XMLHandler.getTagValue( fnode, "maxValue" );
        enumValue[i] = XMLHandler.getTagValue( fnode, "enumValue" );
        prefixValue[i] = XMLHandler.getTagValue( fnode, "prefixValue" );
        suffixValue[i] = XMLHandler.getTagValue( fnode, "suffixValue" );
        characterType[i] = XMLHandler.getTagValue( fnode, "characterType" );
        regularExpress[i] = XMLHandler.getTagValue( fnode, "regularExpress" );
  ...
  public void getFields( RowMetaInterface row, String origin, RowMetaInterface[] info, StepMeta nextStep,
    ...
    try {
      ...
      RowMetaAndData rowMetaAndData = RandomRowGenerator.buildRow( this, remarks, origin );
      if ( !remarks.isEmpty() ) {
  ...
  public String getXML() {
    ...
    for ( int i = 0; i < fieldName.length; i++ ) {
      if ( fieldName[i] != null && fieldName[i].length() != 0 ) {
        ...
        retval.append( "        " ).append( XMLHandler.addTagValue( "minValue", minValue[i] ) );
        retval.append( "        " ).append( XMLHandler.addTagValue( "maxValue", maxValue[i] ) );
        retval.append( "        " ).append( XMLHandler.addTagValue( "enumValue", enumValue[i] ) );
        retval.append( "        " ).append( XMLHandler.addTagValue( "prefixValue", prefixValue[i] ) );
        retval.append( "        " ).append( XMLHandler.addTagValue( "suffixValue", suffixValue[i] ) );
        retval.append( "        " ).append( XMLHandler.addTagValue( "characterType", characterType[i] ) );
        retval.append( "        " ).append( XMLHandler.addTagValue( "regularExpress", regularExpress[i] ) );
        retval.append( "      </field>" ).append( Const.CR );
      }
    }
    retval.append( "    </fields>" ).append( Const.CR );
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases ) throws KettleException {
    try {
      ...
      for ( int i = 0; i < nrfields; i++ ) {
        ...
        minValue[i] = rep.getStepAttributeString( id_step, i, "minValue" );
        maxValue[i] = rep.getStepAttributeString( id_step, i, "maxValue" );
        enumValue[i] = rep.getStepAttributeString( id_step, i, "enumValue" );
        prefixValue[i] = rep.getStepAttributeString( id_step, i, "prefixValue" );
        suffixValue[i] = rep.getStepAttributeString( id_step, i, "suffixValue" );
        characterType[i] = rep.getStepAttributeString( id_step, i, "characterType" );
        regularExpress[i] = rep.getStepAttributeString( id_step, i, "regularExpress" );
    ...
    try {
      for ( int i = 0; i < fieldName.length; i++ ) {
        if ( fieldName[i] != null && fieldName[i].length() != 0 ) {
          ...
          rep.saveStepAttribute( id_transformation, id_step, i, "minValue", minValue[i] );
          rep.saveStepAttribute( id_transformation, id_step, i, "maxValue", maxValue[i] );
          rep.saveStepAttribute( id_transformation, id_step, i, "enumValue", enumValue[i] );
          rep.saveStepAttribute( id_transformation, id_step, i, "prefixValue", prefixValue[i] );
          rep.saveStepAttribute( id_transformation, id_step, i, "suffixValue", suffixValue[i] );
          rep.saveStepAttribute( id_transformation, id_step, i, "characterType", characterType[i] );
          rep.saveStepAttribute( id_transformation, id_step, i, "regularExpress", regularExpress[i] );
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new RandomRowGenerator( stepMeta, stepDataInterface, cnr, transMeta, trans );
  }

  public StepDataInterface getStepData() {
    return new RandomRowGeneratorData();
  }
